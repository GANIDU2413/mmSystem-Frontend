...
import { NavebarSM } from "../../studentMarks/NavebarSM";
import { useParams } from "react-router-dom";

export default function StudentMarks(props) {

  const course_variables = useParams();
  ...
  const loadMarks = async () => {
    try {
      ...
      marksWithChecked.forEach(({ assignment_type }) => {
        uniqueIds.add(assignment_type);
      });
